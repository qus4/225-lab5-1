pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/qus4'                                   //<-----change this to your MiamiID!
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/qus4/225-lab5-1.git'     //<-----change this to match this new repository!
        KUBECONFIG = credentials('qus4-225')                           //<-----change this to match your kubernetes credentials (MiamiID-225)! 
    }
        ...
        stage ("Run Security Checks") {
            steps {
                ...
                sh '''
                    ...
                    -e BURP_START_URL=http://10.48.229.142 \
